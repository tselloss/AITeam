...
Docs written or updated, a short summary of what changed and why, plus a `HANDOFF` block naming the next role — or, since documentation is typically an end state, omit the block entirely per the dead-end exception in `docs/team-protocol.md` § Mechanics.
